...
[t,y1]=classicalRK_4(@combofun,tspan, [s0; I(:,1); I(:,2);I(:,3)], 100);
%[t,y2]=classicalRK_4(@combofun,tspan, [s0; I(:,2)], 100);
%[t,y3]=classicalRK_4(@combofun,tspan, [s0; I(:,3)], 100);


residual = B0*[y1(1:3,1)]+Bb*[y1(1:3,101)]-alpha;
disp('residual is:')
disp(residual)
...
zb = [y1(4:6,101), y1(7:9,101), y1(10:12,101)];
...
residual = B0*[y1(1:3,1)]+Bb*[y1(1:3,101)]-alpha;
%residual = B0*[y1(1,1); y1(2,1); y1(3,1)]+Bb*[y1(1,101); y1(2,101); y1(3,101)]-alpha;
disp('residual is:')
disp(residual)
p2 = plot(t,y1(1,:),'m-.');
hold on
